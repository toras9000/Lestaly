...
{
    /// <summary>同期シーケンスに対するファイルCSV保存メソッド</summary>
    ...
    extension<TSource>(IEnumerable<TSource> self)
    {
        ...
        public Task SaveToCsvAsync(FileInfo file, CancellationToken cancelToken = default)
        {
        ...
        /// <param name="cancelToken">キャンセルトークン</param>
        /// <returns>書き込み処理タスク</returns>
        public Task SaveToCsvAsync(FileInfo file, SaveToCsvOptions options, CancellationToken cancelToken = default)
        {
            ArgumentNullException.ThrowIfNull(file);
        ...
        /// <param name="cancelToken">キャンセルトークン</param>
        /// <returns>書き込み処理タスク</returns>
        public Task SaveToCsvAsync(FileInfo file, SaveToCsvOptions options, Encoding encoding, CancellationToken cancelToken = default)
        {
            ArgumentNullException.ThrowIfNull(file);
        ...
        /// <param name="cancelToken">キャンセルトークン</param>
        /// <returns>書き込み処理タスク</returns>
        public Task SaveToCsvAsync(string filePath, CancellationToken cancelToken = default)
        {
        ...
        /// <param name="cancelToken">キャンセルトークン</param>
        /// <returns>書き込み処理タスク</returns>
        public Task SaveToCsvAsync(string filePath, SaveToCsvOptions options, CancellationToken cancelToken = default)
        {
        ...
        /// <param name="cancelToken">キャンセルトークン</param>
        /// <returns>書き込み処理タスク</returns>
        public Task SaveToCsvAsync(string filePath, SaveToCsvOptions options, Encoding encoding, CancellationToken cancelToken = default)
        {
            return self.ToPseudoAsyncEnumerable().SaveToCsvAsync(filePath, options, encoding, cancelToken);
        }
    }

    /// <summary>非同期シーケンスに対するファイルCSV保存メソッド</summary>
    /// <typeparam name="TSource">シーケンスの要素型</typeparam>
    /// <param name="self">対象シーケンス</param>
    extension<TSource>(IAsyncEnumerable<TSource> self)
    {
        /// <summary>シーケンスデータをCSV(Charactor Separated Field)として保存する。</summary>
        /// <param name="file">保存ファイル</param>
        /// <param name="cancelToken">キャンセルトークン</param>
        ...
        /// <param name="cancelToken">キャンセルトークン</param>
        /// <returns>書き込み処理タスク</returns>
        public async Task SaveToCsvAsync(string filePath, SaveToCsvOptions options, Encoding encoding, CancellationToken cancelToken = default)
        {
            // パラメータチェック
